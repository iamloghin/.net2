namespace ServiceAutoLibrary.Repository.Read.Operatie
{
    ...
    /// Implements the <see cref="T:ServiceAutoLibrary.Repository.Read.Operatie.IReadOperatieRepository" />
    /// </summary>
    /// <seealso cref="T:ServiceAutoLibrary.Repository.Read.Operatie.IReadOperatieRepository" />
    internal class ReadOperatieRepository: IReadOperatieRepository
    {
        ...
        public ReadOperatieRepository(ServiceAutoModelContainer context)
        {
            _context = context;
        }
        ...
        public ServiceAutoLibrary.Operatie GetById(int id)
        {
            return _context.Operatii.FirstOrDefault(o => o.OperatieId== id);
        }
        ...
        public IReadOnlyList<ServiceAutoLibrary.Operatie> GetAll()
        {
        ...
        {
            return _context.Operatii.FirstOrDefault(o => o.OperatieId== id)?.Denumire;
        }
        ...
        public decimal GetTimpExecutie(int id)
        {
            return _context.Operatii.FirstOrDefault(o => o.OperatieId== id).TimpExecutie;
        }
    }
}
